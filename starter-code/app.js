...
function multiply(a, b) {
  ...
  return [mult, string]; //eslint-disable-line
...
function sumArray(sumArr) {
  let sum1 = sum(testArray[0], sumArr[1]);
  let sum2 = sum(sum1[0], sumArr[2]);
  let string = sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' was passed in as an array of numbers, and ' + sum2[0] + ' is their sum.'
...
function multiplyArray(multArr) {
  ...
  return [mult2[0], string] //eslint-disable-line
